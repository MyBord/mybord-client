...
const resolve = {
  ...
  alias: {
    ...
    modal: path.resolve(__dirname, 'src/spa/components/atoms/modals/modal/'),
    modals: path.resolve(__dirname, 'src/spa/components/molecules/modals/'),
    ...
    popOver: path.resolve(__dirname, 'src/spa/components/atoms/modals/popOver/'),
