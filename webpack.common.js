...
const resolve = {
  ...
  alias: {
    ...
    alert: path.resolve(__dirname, 'src/spa/components/molecules/alert/'),
    animations: path.resolve(__dirname, 'src/spa/components/atoms/animations/'),
    api: path.resolve(__dirname, 'src/api/'),
    app: path.resolve(__dirname, 'src/spa/app/'),
    assets: path.resolve(__dirname, 'src/assets/'),
    buttons: path.resolve(__dirname, 'src/spa/components/molecules/buttons/'),
    ...
    icon: path.resolve(__dirname, 'src/spa/components/atoms/icon/'),
    ...
    lottiePlayer: path.resolve(__dirname, 'src/spa/components/atoms/lottiePlayer/'),
    lotties: path.resolve(__dirname, 'src/spa/components/atoms/lotties/'),
    ...
    portal: path.resolve(__dirname, 'src/spa/components/atoms/portal/'),
