module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^alert(.*)$': '<rootDir>/src/spa/components/molecules/alert$1',
    '^animations(.*)$': '<rootDir>/src/spa/components/atoms/animations$1',
    '^api(.*)$': '<rootDir>/src/api$1',
    '^app(.*)$': '<rootDir>/src/spa/app$1',
    '^assets(.*)$': '<rootDir>/src/assets$1',
    '^buttons(.*)$': '<rootDir>/src/spa/components/molecules/buttons$1',
    ...
    '^icon(.*)$': '<rootDir>/src/spa/components/atoms/icon$1',
    '^inputs(.*)$': '<rootDir>/src/spa/shared/inputs$1',
    '^landing(.*)$': '<rootDir>/src/spa/landing$1',
    '^layout(.*)$': '<rootDir>/src/spa/app/layout$1',
    '^lottiePlayer(.*)$': '<rootDir>/src/spa/components/atoms/lottiePlayer$1',
    '^lotties(.*)$': '<rootDir>/src/spa/components/atoms/lotties$1',
    ...
    '^portal(.*)$': '<rootDir>/src/spa/components/atoms/portal$1',
