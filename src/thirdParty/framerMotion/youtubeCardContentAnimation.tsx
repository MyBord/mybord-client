...
import * as styles from './youtubeCardContentAnimation.module.less';
...
const YoutubeCardContentAnimation: React.FC<Props> = ({ children, showYoutubeThumbnail }) => {
...
export default YoutubeCardContentAnimation;
