...
export function getYoutubeData(videoId) {
  const youtubeDataPromise = gapi.getYoutubeData(videoId);
  return {
    youtubeData: wrapPromise(youtubeDataPromise),
  }
}

export function getDummyData() {
  const dummyPromise = fetchDummyData();
  return {
    dummyData: wrapPromise(dummyPromise),
  }
}
